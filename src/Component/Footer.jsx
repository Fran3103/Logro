    ...
    const submit = (e) => {
      ...
      return (
        <section className='container pt-20 sm:max-w-[1240px] max-w-[550px] sm:w-full flex flex-col justify-center items-center p-4 m-auto sm:flex-row sm:grid sm:grid-cols-3 sm:grid-rows-2 sm:gap-3 lg:mt-4'>
          ...
          <article className='newsletter-section flex flex-col w-full items-start  gap-3 my-4 sm:h-56 '>
          ...
          <article className='copyright-section w-full flex flex-col sm:row-start-2 sm:col-start-1 sm:col-end-4 '>
